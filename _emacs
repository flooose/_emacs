...
;; auto-complete
(add-to-list 'load-path "/home/chris/.emacs.d/elpa/popup-0.5/")
(require 'popup)

(add-to-list 'load-path "/home/chris/.emacs.d/elpa/auto-complete-1.4/")
...
;;              "~/.emacs.d/plugins")
;;(add-to-list 'load-path
;;						 "/home/chris/.emacs.d/elpa/yasnippet-bundle-0.6.1")
